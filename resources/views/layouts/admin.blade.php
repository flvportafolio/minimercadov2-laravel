...
<html lang="es">
  ...
  <body>
        ...
        <nav id="sidebarMenu" class="col-md-2 d-md-block bg-light collapse">
          <div class="pt-3">
            <ul class="nav flex-column">
              ...
              <li class="nav-item py-2">
                <a class="nav-link {{request()->routeIs('categoria.index')?'font-weight-bold active':'text-dark'}}" href="{{route('categoria.index')}}">Categorias</a>
              </li>
              <li class="nav-item py-2">
    ...
    <!-- Script Section -->
    <script> @yield('inside_scripts') </script>
    <!-- END Script -->
  </body>
</html>